...
void main(){
 ...
 // translation matrix
  mat3 transForwardMat= mat3(1.0,0.0,-v_center.x, 0.0,1.0,-v_center.y, 0.0,0.0,1.0);
  mat3 transBackwardMat=mat3(1.0,0.0, v_center.x, 0.0,1.0, v_center.y, 0.0,0.0,1.0);
  // rotation matrices
