...
abstract class Constraints {
    ...
    abstract fun alignTopLeft(view: GLView)
    abstract fun alignBottomLeft(view: GLView)
    abstract fun alignTopRight(view: GLView)
    abstract fun alignBottomRight(view: GLView)
